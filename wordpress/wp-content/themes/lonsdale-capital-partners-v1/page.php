...
?>   
    ...
    <div class="content team">
        ...
        <div class="column">
        	...
        	<div class="block sub-nav">
                ...
                <h3>Founders:</h3>
            	<p><a href="<?php echo get_permalink(43);?>" title="Alan Dargan" class="alan-dargan">Alan Dargan</a></p>
            	<p><a href="<?php echo get_permalink(48);?>" title="Ross Finegan" class="ross-finegan">Ross Finegan</a></p>
            	<p><a href="<?php echo get_permalink(50);?>" title="David Gasparro" class="david-gasparro">David Gasparro</a></p>
                
                <p>&nbsp;</p>
                <h3>Investment Professionals:</h3>
            	<p><a href="<?php echo get_permalink(52);?>" title="Ben Evans" class="ben-evans">Ben Evans</a></p>
            	<!--<p><a href="<?php echo get_permalink(54);?>" title="Adam Crinion" class="adam-crinion">Adam Crinion</a></p>-->
                
                <p>&nbsp;</p>
                <h3>Office Manager:</h3>
            	<p><a href="<?php echo get_permalink(57);?>" title="Claire O'Dowd" class="claire-odowd">Claire O'Dowd</a></p>
        ...
        <div class="team-shots">
			...
			?>
            <div class="block"><a href="<?php echo get_permalink(43);?>" title="Alan Dargan" class="alan-dargan"><img src="<?php echo $team_image_1; ?>" alt="Alan Dargan" /></a></div>
            <div class="block"><a href="<?php echo get_permalink(48);?>" title="Ross Finegan" class="ross-finegan"><img src="<?php echo $team_image_2; ?>" alt="Ross Finegan" /></a></div>
            <div class="block last"><a href="<?php echo get_permalink(50);?>" title="David Gasparro" class="david-gasparro"><img src="<?php echo $team_image_3; ?>" alt="David Gasparro" /></a></div>
            
            <div class="block"><a href="<?php echo get_permalink(52);?>" title="Ben Evans" class="ben-evans"><img src="<?php echo $team_image_4; ?>" alt="Ben Evans" /></a></div>
            <div class="block"><a href="<?php echo get_permalink(57);?>" title="Claire O'Dowd" class="claire-odowd"><img src="<?php echo $team_image_6; ?>" alt="Claire O'Dowd" /></a></div>
            <div class="block last blueblock"><!--<a href="<?php echo get_permalink(54);?>" title="Adam Crinion" class="adam-crinion"><img src="<?php echo $team_image_5; ?>" alt="Adam Crinion" /></a>--></div>
       
        </div>

    </div>
    
    <?php elseif(is_page(43) || is_page(50) || is_page(54)): // Team: Single ?>
    <div class="content team">
        ...
        <div class="column">
        	...
        	<div class="block sub-nav">
                ...
                <h3 class="investment-professionals">Investment Professionals:</h3>
            	<p><a href="<?php echo get_permalink(52);?>" title="Ben Evans" class="ben-evans">Ben Evans</a></p>
            	<!--<p><a href="<?php echo get_permalink(54);?>" title="Adam Crinion" class="adam-crinion">Adam Crinion</a></p>-->
                
                <p>&nbsp;</p>
                
                <h3 class="office-manager">Office Manager:</h3>
            	<p><a href="<?php echo get_permalink(57);?>" title="Claire O'Dowd" class="claire-odowd">Claire O'Dowd</a></p>
    ...
    <?php elseif(is_page(48) || is_page(52) || is_page(57)): // Team: Single ?>
    <div class="content team">
    ...
    <div class="content contact">
        ...
        <div class="block"><a href="<?php echo get_permalink(43);?>" title="Alan Dargan" class="alan-dargan"><img src="<?php echo $team_image_1; ?>" alt="Alan Dargan" /></a></div>
        <div class="block last"><a href="<?php echo get_permalink(48);?>" title="Ross Finegan" class="ross-finegan"><img src="<?php echo $team_image_2; ?>" alt="Ross Finegan" /></a></div>
        ...
        <div class="block"><a href="<?php echo get_permalink(50);?>" title="David Gasparro" class="david-gasparro"><img src="<?php echo $team_image_3; ?>" alt="David Gasparro" /></a></div>
        <div class="block last"><a href="<?php echo get_permalink(52);?>" title="Ben Evans" class="ben-evans"><img src="<?php echo $team_image_4; ?>" alt="Ben Evans" /></a></div>
